...
class SecurityError(RAGSystemError):
    ...
    Raised when security validation fails, suspicious activity is detected,
...
class DocumentProcessingError(ProcessingError):
    ...
    Raised when there are issues with document loading, parsing,
    chunking, or content processing operations.
    """
